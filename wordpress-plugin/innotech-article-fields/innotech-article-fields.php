 ...
 * Description: Adds exact read-time and ordered Related News fields to every WordPress post and exposes them through REST.
 * Version: 1.1.0
 * Author: INNOTECH
 */
...
const INNOTECH_ARTICLE_FIELDS_VERSION = '1.1.0';
