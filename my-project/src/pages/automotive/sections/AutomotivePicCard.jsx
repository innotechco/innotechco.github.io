  ...
  return (
    ...
    >
      <article className="relative isolate w-full max-w-[1253px] min-h-[480px] overflow-hidden rounded-[50px] md:min-h-[601px]">
        ...
        <div className="relative z-10 flex flex-col items-start justify-start gap-5 px-8 py-12 md:px-32 md:py-36">
          <nav
          ...
          <p className={`max-w-[631px] font-['Gotham'] text-xl leading-relaxed ${textColor}`}>
            Accelerate intelligent mobility transformation across automotive
            manufacturing, connected vehicle ecosystems, smart mobility
            infrastructures, and AI-enabled engineering systems through
            predictive technology analytics and scalable digital architectures.
          </p>
        </div>
      </article>
    </main>
