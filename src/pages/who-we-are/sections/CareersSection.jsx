    ...
    <section className="flex flex-col items-start gap-2.5 overflow-hidden px-6 py-14 md:px-16 xl:min-h-[640px] xl:px-[120px]">
      ...
      >
        <div className="flex flex-1 flex-col items-start justify-start gap-8 self-stretch p-6 sm:p-10 xl:p-16">
          ...
          <button
            type="button"
            className={`inline-flex min-h-11 items-center justify-center rounded-[50px] bg-[#22C55E] px-4 py-2 font-['Gotham'] text-xl font-bold sm:text-2xl ${invertedTextColor} shadow-lg transition-all duration-200 hover:bg-[#16A34A] hover:shadow-xl active:scale-95`}
          >
            {content.buttonLabel}
          </button>
        </div>
