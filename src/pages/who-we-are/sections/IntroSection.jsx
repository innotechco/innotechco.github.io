  ...
  return (
    <section className="mb-20 px-6 py-[30px] md:px-16 xl:px-[120px]">
      <div className="mx-auto grid w-full max-w-[1600px] items-center gap-8 lg:grid-cols-[minmax(0,1fr)_24rem]">
        <div className="relative flex min-w-px flex-1 flex-col items-start justify-center gap-4 p-4 sm:p-9">
        ...
        <div className="relative mx-auto aspect-square w-full max-w-96 shrink-0 overflow-hidden rounded-[32px] lg:rounded-[50px]">
          <img
            loading="lazy"
            src={image}
            alt=""
