import {getActiveLocale} from "./locale.js";

const messages = {
  en: {
    loading: "Loading", readMore: "Read more", menu: "Menu", whoWeAre: "Who we are", whatWeDo: "What we do",
    whatWeThink: "What we think", academy: "INLEARN Academy", academySoon: "INLEARN Academy is coming soon", store: "INSIGHT Store", rfp: "RFP",
