import {fetchJsonFromApi} from "./utils.js";
import {getActiveLocale} from "../i18n/locale.js";
import {fetchWordPressPost} from "../../integrations/wordpress/client/wordpressBlog.js";
...
export async function fetchArticle(slug) {
  return (await fetchWordPressPost(slug, {locale: getActiveLocale()})) ??
    (await fetchJsonFromApi(`/articles/${slug}`)) ??
    getArticle(slug);
}
