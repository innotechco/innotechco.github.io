function WhoWeAreBackground({images, isDarkMode}) {
  ...
  const positions = {
    ...
    top2: "top-[150px] 2xl:top-[20px] xl:top-[90px] sm:top-[200px] md:top-[200px] lg:top-[120px]",
    middle: "top-[2620px] sm:top-[2570px] md:top-[2700px] lg:top-[2200px] xl:top-[2080px] [@media(min-width:1280px)_and_(max-width:1411px)]:top-[2180px] 2xl:top-[2088px]",
  };
