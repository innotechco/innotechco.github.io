/* ISO 3166 country names and two-letter codes. Bundled rather than fetched:
   ...
   `dial` is the country calling code, kept here for the same reason: the phone
   field prefills it from the chosen region, and a signup form must not depend
   on a third party to know that Germany is +49.

   Generated from countriesnow.space, sorted by name. Greece was missing a dial
   code in that response and carries the ITU value instead. */
export const countries = [
  ...
  {name: "Bouvet Island", code: "BV", dial: "+55"},
  ...
  {name: "Pitcairn", code: "PN", dial: "+870"},
  ...
  {name: "United States Minor Outlying Islands", code: "UM", dial: "+1581"},
  {name: "Uruguay", code: "UY", dial: "+598"},
  {name: "Uzbekistan", code: "UZ", dial: "+998"},
  {name: "Vanuatu", code: "VU", dial: "+678"},
  {name: "Vatican City State (Holy See)", code: "VA", dial: "+379"},
...
/* Name to calling code, because the Region select speaks in names. */
const dialByName = new Map(countries.map((country) => [country.name, country.dial]));

export function dialCodeFor(countryName) {
  return dialByName.get(countryName) || "";
}
